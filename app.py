...
workbook_alunos = openpyxl.load_workbook('mateus/planilha_alunos.xlsx')
sheet_alunos = workbook_alunos['Sheet1']


for indice,linha in enumerate (sheet_alunos.iter_rows(min_row=2), start=1):
    ...
    image = Image.open ('./mateus/certificado_padrao.jpg')
